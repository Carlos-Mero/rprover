...
\begin{itemize}
  ...
  \item \textbf{True Positive Rate (TPR, recall)}: The proportion of proofs classified as correct among all truly correct proofs. This helps assess the model’s proof-verification capability.
  \item \textbf{Precision}: The proportion of truly correct proofs among all proofs that the model classifies as correct. This measures the reliability of the model’s “correct” predictions.
  \item \textbf{F1 Score}: The harmonic mean of precision and recall, providing a balanced indicator of performance when both false positives and false negatives matter.
\end{itemize}
...
\begin{figure}[htbp]
  ...
  \caption{The main results under progressive pessimistic verification. Thinking mode is enabled for all models if possible, and the reasoning effort of gpt series model is set to medium. This method constantly improves the classification performance across all tested models.}
